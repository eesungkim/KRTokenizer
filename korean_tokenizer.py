class HangulSplitterCombiner:
    ...
    # Reverse mapping: jamo -> final consonant index
    ...
    def decompose(self, text: str) -> str:
        ...
        For each Hangul syllable in `text`, separate it into:
         ...
         - followed by a separate jamo character if 종성 != 0
        ...
        for char in text:
            ...
            # If there's a final consonant, append it separately
            if f_idx != 0:
    ...
    def compose(self, text: str) -> str:
        ...
        while i < length:
            ...
            # Otherwise, no final or next char not a valid final
